...
export RESULT_DIR_NORMAL=${RESULT_DIR_NORMAL:-"results_${RESULT_POSTFIX}_normal"}
export RESULT_DIR_READ_ONLY=${RESULT_DIR_READ_ONLY:-"results_${RESULT_POSTFIX}_read-only"}
